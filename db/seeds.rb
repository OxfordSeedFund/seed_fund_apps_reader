...
apps_array_of_row_hashes = CSV.read('db/seed_fund_apps_v7.csv', :encoding => 'windows-1251:utf-8', :headers => true, :header_converters => :symbol, :converters => :all).map {|row| Hash[row.map{|row_head,row_val| [row_head,row_val]}]}
